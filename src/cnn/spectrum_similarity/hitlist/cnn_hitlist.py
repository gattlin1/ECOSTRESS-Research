...
# CNN implementation of a hitlist. In order to speed up runtime, the program
# assumes every entry is already created. This means that for each spectrum
# there is an entry with it and every other spectra in the dataset. This file
# is just the class, the actual use of this class is in run_hitlist.py.
